...
class StopLineReading {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('line_angle')) {
        this.line_angle = initObj.line_angle
      }
      else {
        this.line_angle = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [line_angle]
    bufferOffset = _serializer.float32(obj.line_angle, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [line_angle]
    data.line_angle = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '55f653b3c7e032a4d334c48bf9dce3f5';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.line_angle !== undefined) {
      resolved.line_angle = msg.line_angle;
    }
    else {
      resolved.line_angle = 0.0
    }
